...
# fn = "N_part19__alpha0.1__expt_nameGTstudy1__NHID1__NONLINrbf__L20.0__test_epoch0__test_lr0.0__train_epoch300__train_lr0.01__plot_data"
# data1 <- as.data.frame(fromJSON(txt=fn))
# 
...
# data2 <- as.data.frame(fromJSON(txt=fn))
# 
...
# data3 <- as.data.frame(fromJSON(txt=fn))
# 
# data0 <- rbind(data1, data2)
# data <- rbind(data3, data0)

fn = "N_part19__alpha0.01__expt_nameGTstudy1__NHID1__NONLINrbf__L20.0__test_epoch0__test_lr0.0__train_epoch300__train_lr0.01__plot_data"
data <- as.data.frame(fromJSON(txt=fn))
...
exact = rep(c(rep(TRUE, 300), rep(FALSE, 300)),54)
...
df = data.frame(mu = summary(model_lm_stimuli)$coefficients[1:2,1],
  se = summary(model_lm_stimuli)$coefficients[1:2,2],
