...
fn = "N_part9__expt_namePM__fix_llFalse__fix_priorFalse__NHID2__NONLINrbf__L20.0__test_epoch0__test_lr0.0__train_epoch300__train_lr0.01__plot_data"
...
plot2 <- ggplot(df, aes(y = coeff, x = prior)) +
  geom_point() + geom_line() + ggtitle("Prior binned regression coeff") + ylim(c(0.0, 1.5))
plot2
